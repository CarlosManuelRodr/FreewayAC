...
mkdir "Open"
cp "plot.m" "Open/"
../Release/Freeway --size=$SIZE --iter=$ITER --density=$DENSITY --rand_prob=$RAND_PROB --ca_open --new_car_prob=$NEW_CAR_PROB \
                   --new_car_speed=$NEW_CAR_SPEED --path="Open/" --show_progress=false &
../Release/Freeway --size=$SIZE --iter=$ITER --rand_prob=$RAND_PROB --ca_open --new_car_prob=$NEW_CAR_PROB --new_car_speed=$NEW_CAR_SPEED \
...
../Release/Freeway --size=$SIZE --iter=$ITER --density=$DENSITY --ca_open --new_car_prob=$NEW_CAR_PROB --new_car_speed=$NEW_CAR_SPEED \
                   --flow_vs_rand_prob --rand_prob_min=0.0 --rand_prob_max=1.0 --dt=$DT --path="Open/" --show_progress=false &
../Release/Freeway --size=$SIZE --iter=$ITER --density=$DENSITY --ca_open --new_car_speed=$NEW_CAR_SPEED --flow_vs_new_car \
...
../Release/Freeway --size=$SIZE --iter=$ITER --density=$DENSITY --rand_prob=$RAND_PROB --ca_autonomous --aut_density=$AUT_DENSITY \
                   --path="Autonomous/" --show_progress=false &
../Release/Freeway --size=$SIZE --iter=$ITER --rand_prob=$RAND_PROB --ca_autonomous --aut_density=$AUT_DENSITY  \
...
../Release/Freeway --size=$SIZE --iter=$ITER --density=$DENSITY --ca_autonomous --aut_density=$AUT_DENSITY  \
                   --flow_vs_rand_prob --rand_prob_min=0.0 --rand_prob_max=1.0 --dt=$DT --path="Autonomous/" --show_progress=false &
../Release/Freeway --size=$SIZE --iter=$ITER --density=$DENSITY --ca_autonomous --flow_vs_aut_cars --aut_min=0.0 \
...
mkdir "Stop"
cp "plot.m" "Stop/"
../Release/Freeway --size=$SIZE --iter=$ITER --density=$DENSITY --rand_prob=$RAND_PROB --ca_stop --stop_density=$STOP_DENSITY \
                   --path="Stop/" --show_progress=false &
../Release/Freeway --size=$SIZE --iter=$ITER --rand_prob=$RAND_PROB --ca_stop --stop_density=$STOP_DENSITY  \
...
../Release/Freeway --size=$SIZE --iter=$ITER --density=$DENSITY --ca_stop --stop_density=$STOP_DENSITY  \
                   --flow_vs_rand_prob --rand_prob_min=0.0 --rand_prob_max=1.0 --dt=$DT --path="Stop/" --show_progress=false &
../Release/Freeway --size=$SIZE --iter=$ITER --density=$DENSITY --ca_stop  --flow_vs_stop_density \
...
mkdir "Semaphore"
cp "plot.m" "Semaphore/"
../Release/Freeway --size=$SIZE --iter=$ITER --density=$DENSITY --rand_prob=$RAND_PROB --ca_semaphore --semaphore_density=$SEMAPHORE_DENSITY \
                   --random_semaphores=$RANDOM_SEMAPHORES --path="Semaphore/" --show_progress=false &
../Release/Freeway --size=$SIZE --iter=$ITER --rand_prob=$RAND_PROB --ca_semaphore --semaphore_density=$SEMAPHORE_DENSITY  \
...
../Release/Freeway --size=$SIZE --iter=$ITER --density=$DENSITY --ca_semaphore --semaphore_density=$SEMAPHORE_DENSITY  \
...
../Release/Freeway --size=$SIZE --iter=$ITER --density=$DENSITY --ca_semaphore  --flow_vs_semaphore_density \
...
../Release/Freeway --size=$SIZE --iter=$ITER --density=$DENSITY --rand_prob=$RAND_PROB --ca_simple_junction --new_car_prob=$NEW_CAR_PROB \
                   --new_car_speed=$NEW_CAR_SPEED --path="SimpleJunction/" --show_progress=false &
../Release/Freeway --size=$SIZE --iter=$ITER --rand_prob=$RAND_PROB --ca_simple_junction --new_car_prob=$NEW_CAR_PROB --new_car_speed=$NEW_CAR_SPEED \
...
../Release/Freeway --size=$SIZE --iter=$ITER --density=$DENSITY --ca_simple_junction --new_car_prob=$NEW_CAR_PROB --new_car_speed=$NEW_CAR_SPEED \
                   --flow_vs_rand_prob --rand_prob_min=0.0 --rand_prob_max=1.0 --dt=$DT --path="SimpleJunction/" --show_progress=false &
../Release/Freeway --size=$SIZE --iter=$ITER --density=$DENSITY --ca_simple_junction --new_car_speed=$NEW_CAR_SPEED --flow_vs_new_car \
